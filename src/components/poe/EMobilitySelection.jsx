						...
						<div>
							...
							>
								...
								<div className="w-full xl:pb-5">
									<div className="w-full px-5 py-2 xl:py-3 bg-primary-light text-white font-bold text-xs xl:text-xl">
										E-Vehicles
									</div>
							...
							<button
								onClick={sendUser}
								className="mx-auto py-3 px-5 bg-primary-light mt-6 mb-16"
							>
								Send
							</button>
						</div>
